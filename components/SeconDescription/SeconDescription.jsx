...
const SeconDescription = () => {
  return (
    <div className="description" >
      ...
      <p>
        <span style={{fontSize: '6rem', color: 'rgba(139, 17, 17, 2.5)'}}> " </span> A series of techniques I've learned throughout my life have helped me become a highly valuable worker. From sausage making, grinding, cutting, and preparing meats to advising customers on the best cuts for their planned dishes, my expertise is broad. I excel in quality control, inventory management, and training and supervising staff. These are just a few of the qualities that define me, along with a deep commitment to delivering the best service and ensuring customer satisfaction in every aspect of my work. 
        </p>
        <video autoPlay muted controls className="working1" src="./working2.mp4"></video>
    </div>
  )
}

export default SeconDescription
